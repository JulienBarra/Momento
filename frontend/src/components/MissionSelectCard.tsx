...
export default function MissionSelectCard({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center px-4 pt-4 pb-[calc(5rem+env(safe-area-inset-bottom))] overflow-y-auto">
      {/* Card principale — contrainte à l'espace au-dessus de la navbar (pb du parent). */}
      <div className="bg-white rounded-2xl w-full max-w-lg max-h-full flex flex-col shadow-2xl animate-fade-in">
        {/* Header */}
